...
IPAddress TCP_IP ( 192, 168, 1, 173 );				// Configure your static ip-address here
...
int main(void) {
  ...
  gw.begin(RF24_PA_LEVEL, RF24_CHANNEL, RF24_DATARATE, writeEthernet, RADIO_RX_LED_PIN, RADIO_TX_LED_PIN, RADIO_ERROR_LED_PIN);
  server.begin();
  while (1) {
